...
public enum ScaleFactor {
	...
	QC_THROTTLE_STICK(1040, 1937, -20, 20, CraftTypes.QUADCOPTER_X, ScaleFactorConstants.THROTTLE),
	QC_RUDDER_STICK(1100, 1940, -40, 40, CraftTypes.QUADCOPTER_X, ScaleFactorConstants.RUDDER),
	QC_MODE_STICK(1124, 1960, -100, 100, CraftTypes.QUADCOPTER_X, ScaleFactorConstants.MODE),
	QC_P_STICK(1050, 1890, 0.5f, 10.5f, CraftTypes.QUADCOPTER_X, ScaleFactorConstants.P),
	QC_I_STICK(1050, 1890, 0, 10f, CraftTypes.QUADCOPTER_X, ScaleFactorConstants.I),
	...
	public static ScaleFactor getFactor(ScaleFactorConstants type) {
		for(ScaleFactor factor : ScaleFactor.values()){
			if(factor.craftType.equals(CommonConstants.craftType) && factor.type.equals(type))
				return factor;
		}
		return null;
	}
